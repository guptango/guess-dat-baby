<script>
    ...
    // Props
    let { gameData: baseGameData, celebrityImages, maleCelebrities, femaleCelebrities, mommy, daddy } = $props();
    ...
    let gameData = $state([...baseGameData]);
    ...
    function checkSubmissionReadiness() {
        // This function can be used for side effects when submission readiness changes
